        ...
        <div class="container">
          <div class="page-inner">
            ...
            <?php
                      ...
                      ?>
              <div>
                <h3 class="fw-bold mb-3">Total Cricket Match Ticket Orders: <?php echo  $total_cricket_tickets; ?></h3>

              </div>
            </div>
            <?php
                      $sql = "SELECT DISTINCT `match_name`, `team_one`, `team_two` FROM `cricket_order` ORDER BY `id` DESC";
                      $result = mysqli_query($conn, $sql);
                      $num = mysqli_num_rows($result);
                      
                      if ($num == 0) {
                      ?>
                          <h5 class="text-center"><b>No one bought a ticket for the cricket match!</b></h5>
                      <?php
                      } else {
              ...
              <div class="card card-round">
                  <div class="card-header">
                    <div class="card-head-row card-tools-still-right">
                      <div class="card-title"><?php echo $match_name ?>: <?php echo $team_one ?> vs <?php echo $team_two ?>  Match Ticket Orders</div>
                  ...
                  <div class="card-body p-0">
                    <div class="table-responsive">
                      ...
                      <table class="table align-items-center mb-0">
                        ...
                        <tbody >
                        <?php
                        $sql = "SELECT * FROM `cricket_order` WHERE `match_name`='$match_name' AND `team_one`='$team_one' AND `team_two`='$team_two' ORDER BY `id` DESC";
                        ...
                        ?>
                          <tr>
                            ...
                            <td class="text-end" style="font-size: 12px!important;"><?php echo $row['match_name']; ?></td>
