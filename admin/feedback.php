        ...
        <div class="container">
          <div class="page-inner">
            ...
            <?php
                      ...
                      ?>
              <div>
                <h3 class="fw-bold mb-3">Total Feedbacks: <?php  echo $row; ?></h3>
                      ...
                      <table class="table align-items-center mb-0">
                       ...
                       ?>
                          <tr>
                            ...
                            <td class="text-end"><?php echo $row['feedback']; ?></td>
                            <td class="text-end"><?php echo $row['time']; ?></td>
                            <td class="text-end">
...
<script>
    ...
    $('#exampleModal').on('show.bs.modal', function (event) {
        ...
        var modal = $(this);
        modal.find('#deleteButton').attr('href', 'delete_feedback.php?id=' + feedbackId);
    });
</script>
