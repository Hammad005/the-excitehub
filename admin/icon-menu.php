							...
							<div class="card card-primary bg-primary-gradient">
								<div class="card-body">
									...
									<ul class="list-unstyled">
										<li class="d-flex justify-content-between pb-1 pt-1"><small>/product/readypro/adminpanel.php</small> <span>7</span></li>
                    ...
                    <div class="table-responsive">
                      ...
                      <table class="table align-items-center mb-0">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <th scope="row">/kaiadmin/adminpanel.php</th>
                            <td>3,985</td>
                            <td>319</td>
                            <td>
                              <i
