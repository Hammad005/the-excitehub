            ...
            <div class="page-inner">
                    ...
                    if(isset($_GET['id'])){
                      echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
                            <strong>Updated!</strong> Admin account information has been updated.
                    ...
                    <div class="account-info col-md-6">
                            ...
                            <a class="btn btn-secondary" href="edit_admin.php?id=<?php echo $row['id']; ?>">
                            <i class="far fa-edit"></i>
                            Edit Information!
                            </a>
                          </div>
                          <p class="small"><b style=" font-weight: bold;">Note:</b> The admin account cannot be deleted.</p>
            </div>
        </div>
