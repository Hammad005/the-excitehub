...
<body>
  ...
  <!-- event tickets -->
  <section id="cricket_tickets">
    <div class="main-block">
      <div class="left-part">
        <a href="event.php"><img src="logo/default6.png" alt="" style="padding-right: 20px;"></a>
      </div>
      <form action="cricket_match.php" Method="Post" id="myForm">
        <div class="title">
        ...
        <div class="info">
          <label>Name :</label>
          <input class="fname" type="text" name="username" value="<?php echo $username?>" readonly  placeholder="Full name" maxlength="50" required>
          <label>Email :</label>
          <input type="email" name="email" placeholder="Email" value="<?php echo $email ?>" readonly required>
          <label>Match :</label>
          <input type="text" id="phoneNumber" name="match_name" value="<?php echo $row['match_name'] ?>" readonly placeholder="Match" required>
          <label class="inline-input">
          Teams: <br>
          <input type="text" id="teamOne" name="team_one" value="<?php echo $row['team_one'] ?>" readonly placeholder="Team One" required>
          <label class="inline-input"><b>Vs</b></label>
          <input type="text" id="teamTwo" name="team_two" value="<?php echo $row['team_two'] ?>" readonly placeholder="Team Two" required>
          </label>
          <?php
          ...
          $dis = $query_fetch['dis_cricket'];
          }
          ?>
          <label>Ticket Price :</label>
          <input type="number" id="price" name="price" value="<?php echo $row['price'] ?>" readonly placeholder="Ticket Price" required>
          <script>
          ...
          <?php
                    if($sub>0){
                        echo '<label style="text-align: right;"><small>Because you have subscribed to the '. $package .' you received a '. $dis .'% discount on the cricket match.</small></label>';
                      }
          ?>
          <label>Tickets:</label>
        ...
        <button type="submit" class=" mt-2" name="match_order"><strong>Book Now!</strong></button>
      </form>
    </div>
</section>
  <!-- end event tickets -->
