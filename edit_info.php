  ...
  <section id="manage" class="d-flex align-items-center justify-content-center">
      <div class="container" data-aos="fade-up">
          ...
          <div class="account-info col-md-6 ms-auto me-auto">
                ...
                <a href="manage_acc.php" class="get-started-btn mt-2" style="background-color: gray!important; border-color: gray!important;">Cancel</a>
                <button type="submit" class="get-started-btn mt-2" name="manage">Update!</button>
        </div>
        </form>
      </div>
